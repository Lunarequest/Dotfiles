...
export CXX=clang++
export LINKCC=clang
export COMMON_FLAGS="-march=haswell -mtune=haswell -O3 -pipe -msse -msse2 -msse3 -mmmx -m3dnow -D_FORTIFY_SOURCE=2 -D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -fstack-clash-protection -fcf-protection"
